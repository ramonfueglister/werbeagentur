...
Halten Sie sich genau an die Anweisungen. Gehen Sie Schritt für Schritt vor und bearbeiten Sie die folgenden Aufgaben. *Achten Sie darauf, dass Sie regelmässig Sicherheitskopien ihrer Arbeit anfertigen.*

Neben dieser Homepage sind für Sie folgende Infos und Dokumente wichtig:

-   [Projektjournal](docs/Projektjournal.docx)
-   [Vertragsentwurf](docs/Vertrag_Fies.docx)
-   Teamsauftrag "Projekt" für die Abgabe
-   [Selbstbeurteilung](https://forms.office.com/e/c5X7LxLLUY)
...
-   Eine eigene Social Media Agentur mit passendem Namen, Logo und einer Titelseite einer eigener Homepage erstellt haben.
-   Einen Auftrag professionell bearbeitet haben (inkl. E-Mails und Elevator Pitch) und eine Umfrage mit mindestens 25 Personen durchgeführt haben.
...
### 1.2 Was macht eine Social Media/Marketingagenturr?

-   [ ] Bescheid wissen, was eine Socia-Media/Marketing-Agentur macht. ⌚ 10min, 🧠

Schauen Sie sich das Videos über den Tagesablauf von Viet Pham Tuan, Gründer einer Social-Media/Marketing Agentur an. Wie sieht sein Tagesablauf aus?
...
```{r}
"Du bist jetzt ein Marketing und Social-Media Experte. Erkläre mir möglichst einfach und klar was eine Social-Media/Marketing Agentur macht. Zielgruppe sind 16jährige Lernende"
```
...
Wählen Sie einen passenden Namen für ihre Social Media-Agentur. Der Name sollte frisch, spannend und kreativ sein sowie Ihre Identität als Gruppe/Agentur klar ausdrücken. Sie können sich dabei durch ChatGPT unterstützen lassen. Unten finden Sie eine möglichen Prompt (Eingabe), welche Sie verwenden können. Experimentieren Sie mit dem Prompt und denken Sie daran, dass Sie ihre Auswahl auch begründen müssen.

```{r}
"Du bist jetzt ein Marketing Experte. Erstelle uns passende Namen für eine neue Werbeagentur. Uns ist besonders wichtig, unsere Stärken sind, dass wir besonders gute Teamplayer sind."
```
...
Designen Sie ein Logo. Sie können das Logo entweder selber gestalten oder mit dem folgenden Tool [Playground](https://huggingface.co/spaces/playgroundai/playground-v2.5) (ohne Registrierung möglich). Sie können das Logo auch mit ChatGPT erstellen. Speichern Sie das Logo ab. Es muss professionell aussehen. Wie man passende Eingaben erstellt finden Sie unter: [Tutorial](https://stable-diffusion-art.com/prompt-guide/)
...
Führen Sie die Umfrage mit 25 Personen durch. Es dürfen nur diejenigen Personen die Umfrage durchführen, welche auch in die Zielgruppe gehören. **Es dürfen keine Kolleginnen aus der Klasse die Umfrage ausführen**. Denken Sie daran, dass die Umfrage ernsthaft ausgefüllt werden muss.
...
-   Titelseite (Homepage) Ihrer Werbeagentur
