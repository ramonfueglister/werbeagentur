...
Falls Sie die Zusage für den Auftrag erhalten haben, geht es noch darum ihr Honorar (Ihr Lohn) für das Projekt zu verhandeln. Sie müssen das direkt mit der Leiterin der Kommunikationsabtei-lung der Auftraggeberin, Fr. Fies, machen. Sie wird sich per Chat bei Ihnen melden. Öffnen Sie ChatGPT [ChatGPT](https://chat.openai.com/) und loggen Sie sich ein. Kopieren Sie den folgenden Mega-Prompt in eine neue Unterhaltung und legen Sie los:
