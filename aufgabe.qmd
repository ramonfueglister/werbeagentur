...
- [ ] finalen Preis notieren, welcher bei der Vertragsverhandlung rausgekommen ist.
...
- [ ] Grundwissen zum Thema "Umfrage" erwerben. 
- [ ] Einen Kurztest zum Grundwissen mit mindestens 60% bestehen.
...
### 2.2 Womit kann ich eine professionelle Umfrage erstellen?

- [ ] Sich kurz in die Möglichkeiten von Findmind einlesen.
...
- [ ] Erstellen einer Umfrage mit Findmind.

Mit ihrem theoretischen Wissen können Sie jetzt eine Umfrage für ihre Auftraggeberin erstellen. Eine Kurzumfrage sollte 12-15 Fragen umfassen und nicht länger als 5-10 Minuten zum Ausfüllen benötigen. Wichtig ist es, dass Sie sich möglichst genau an den Anforderungen der Auftraggeberin orientieren. (Was müssen Sie rausfinden? Wer soll befragt werden?)

### 2.5 Testen der Umfrage und Peer-Feedback

Veröffentlichen Sie den Fragebogen im Teams ABU. Testen Sie den Fragebogen mit verschiedenen Personen aus der Klasse ob er so funktioniert wie gewünscht.
...
Schicken Sie den Link zur Umfrage an das Unternehmen. Warten Sie das Feedback ab.
