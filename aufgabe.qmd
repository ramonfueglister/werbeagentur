...
Welche weiteren Aufgaben übernimmt eine Social-Media/Marketing Agentur? Übertragen Sie die folgende Eingabe (Prompt) für ChatGPT, indem Sie zuerst auf "Zeige den ChatGPT-Prompt" drücken und dann auf "Copy to Clipboard" drücken. 
...
Designen Sie ein Logo. Sie können das Logo entweder selber gestalten oder mit dem folgenden  [Tool](https://app.logodiffusion.com/register)
(Zur Registrierung können Sie Ihre ZAG E-Mail Adresse verwenden). Speichern Sie das Logo ab. Es muss professionell aussehen. Ein Tutorial dazu finden Sie unter:
\
